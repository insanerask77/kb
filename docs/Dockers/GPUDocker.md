...
## [Enabling GPU access to service containers](https://docs.docker.com/compose/gpu-support/#enabling-gpu-access-to-service-containers)
...
For more information on these properties, see the `deploy` section in the [Compose Specification](https://docs.docker.com/compose/compose-file/deploy/#devices).

### [Example of a Compose file for running a service with access to 1 GPU device:](https://docs.docker.com/compose/gpu-support/#example-of-a-compose-file-for-running-a-service-with-access-to-1-gpu-device)
...
## [Access specific devices](https://docs.docker.com/compose/gpu-support/#access-specific-devices)
