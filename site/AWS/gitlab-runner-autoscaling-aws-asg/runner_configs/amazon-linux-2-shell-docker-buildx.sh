...
######################################################
#Runner Config for Docker Buildx created by jeffersonj
#######################################################
...
#Creating cli-plugins dir & house Buildx binaries
mkdir -p ~/.docker/cli-plugins
cp buildx ~/.docker/cli-plugins/docker-buildx
chmod a+x ~/.docker/cli-plugins/docker-buildx


#Installing cross-platform emulator collection 
docker run --privileged --rm tonistiigi/binfmt --install all

#Create new instances of isolated builder
...
cp buildx /home/gitlab-runner/.docker/cli-plugins/docker-buildx
chmod a+x /home/gitlab-runner/.docker/cli-plugins/docker-buildx
chown gitlab-runner:gitlab-runner -R /home/gitlab-runner/.docker/
